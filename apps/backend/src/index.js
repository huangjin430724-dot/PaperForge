...
console.log('');
console.log(`  PaperForge started at http://localhost:${PORT}`);
console.log('');
...
if (tunnelMode !== 'false' && tunnelMode !== '0' && tunnelMode !== 'no') {
  ...
  console.log('    PaperForge_TUNNEL=localtunnel npm start');
  console.log('    PaperForge_TUNNEL=cloudflared npm start');
  console.log('    PaperForge_TUNNEL=ngrok npm start');
  console.log('');
}

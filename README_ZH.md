...
[![发布包](https://img.shields.io/badge/📦-发布包-f4a261?style=for-the-badge)](docs/RELEASE.md)
...
<div align="center">
<br>
<img src="static/首页.gif" alt="PaperForge 主页面" width="90%"/>
<br>
...
PaperForge 是一个面向学术写作的本地部署 LaTeX + AI 工作台，强调高效编辑、可控改动与隐私安全。
...
- **多项目管理**：Projects 独立面板
- **工作区启动台**：快速进入新建项目、模板库、系统状态和演示项目指南
...
<!-- ## 🔄 PaperForge vs Prism 功能对比

> **Prism** 是 OpenAI 于 2026-01-27 发布的云端 LaTeX 写作平台。**PaperForge** 是开源、可自托管的替代方案，强调隐私与数据自主。

### 📝 写作与编辑

| 功能 | PaperForge | Prism (OpenAI) |
|:---|:---:|:---:|
...
> 💡 **总结**：Prism 依托 GPT-5.2 与云端协作提供开箱即用的体验，但数据完全托管在 OpenAI。PaperForge 作为开源替代，支持**本地部署、私域协作、自定义模型**，适合对数据隐私和自主可控有要求的团队与个人。
...
PaperForge 需要 LaTeX 编译引擎来生成 PDF，请根据操作系统选择以下方案之一：
...
PaperForge 支持任何 **OpenAI 兼容**接口，包括自定义 base_url：
...
PaperForge 内置基于 CRDT（Yjs）+ WebSocket 的实时协作系统，支持多人同时编辑同一文档，无需第三方服务。
...
1. **部署服务**：将 PaperForge 部署到有公网 IP 的服务器，配置域名与 HTTPS
...
没有公网服务器也可以远程协作，PaperForge 内置了隧道支持，一条命令即可将本地服务暴露到公网。
...
> **注意**：隧道默认关闭，普通 `npm start` 不会创建隧道。也可通过环境变量手动指定：`PaperForge_TUNNEL=ngrok npm start`
...
<img src="static/wechat.png" alt="PaperForge 微信交流群" width="300"/>
<br>
<sub>扫码加入微信交流群</sub>
